...
const Profile = () => {
  return (
    ...
    <div className="pb-6">
            ...
            <div className="w-full text-center">
                <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                    <div className="flex space-x-2">
                        ...
                        <a className="p-1 -m-1 text-gray-400 hover:text-blue-500 focus:outline-none focus-visible:ring-2 ring-primary" href="https://www.github.com/Smilesharks" rel="noopener" aria-label="Ariel Cerda on Github" >
        ...
        <div className="relative h-6 overflow-hidden sm:translate-y-28 rounded-b-xl">
